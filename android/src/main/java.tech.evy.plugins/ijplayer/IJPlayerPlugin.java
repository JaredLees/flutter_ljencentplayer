package android.src.main.java.tech.evy.plugins.ijplayer;
 ...
 * DdPlayerPlugin
 */
public class IJPlayerPlugin implements MethodCallHandler {
    private Activity activity;
    private Context context;
    private static final String CHANNEL_NAME = "tech.evy.plugins/ijplayer/";
